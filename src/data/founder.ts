export const founder = {
  ...
  whyFree:
    "I removed Retainr's platform subscriptions, seat fees, and feature tiers because a dependable client system should not become another monthly burden for an independent professional. Retainr is free forever. If it helps your business, following my work or sharing Retainr is welcome, but always optional.",
  principle:
    "Your money is not the price of access. Retainr should earn your recommendation by helping you do better client work.",
} as const;
